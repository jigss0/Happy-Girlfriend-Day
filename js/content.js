...
const DIARY_PAGES = [
  {
    ...
    text: "I don’t know if you’ll ever realize how much these little moments mean to me. They stay with me longer than you think. I’m just grateful they’re with you."
  },
  {
    title: "The Little Things I Love",
    img: "diary2.jpg",
    decor: ["paperclip-tr","stamp-bl"],
    text: "every day with you gave me something worth remembering. That’s why I never want to forget these moments."
  },
  {
    title: "Gratitude",
    img: "diary3.jpg",
    decor: ["flower-tl","washi-br"],
    text: "If I ever read this again years from now, I hope we’re still making new memories together. You make my world feel a little brighter."
  },
  {
    title: "Apology",
    img: "diary4.jpg",
    decor: ["coffee-tl","paperclip-br"],
    text: "I smiled because of you again.I hope life always gives us reasons to smile together. ❤️"
  },
  {
    title: "Promise",
    img: "diary5.jpg",
...
const SCRATCH_CARDS = [
  { id:"impression", title:"Cute Photo", img:"scratch1.jpg", text:"I thought you were the kind of person who already had somewhere better to be — and then you stayed anyway, and asked me a real question instead of a small one." },
